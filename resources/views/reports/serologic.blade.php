    ...
    <body style="background-image: url({{ public_path('images/template.png') }})">
        <div style="margin-top: 40px; padding: 60px;">
            ...
            <table style="margin: 10px 0px; width: 100%">
                <tr>
                    <td>PACIENTE: {{ $test->client->FullName }}</td>
                    <td style="text-align: right;"><strong>FECHA:</strong> {{ $test->DateOfTest }}</td>
                </tr>
                <tr>
                    <td>
                        DNI/CE/OTRO: {{ $test->client->document_number }}
                        @if ($test->client->passport != null)
                            <br>PASAPORTE:<br>
                            {{ $test->client->passport }}
                        @endif
                    </td>
                    <td style="text-align: right;"><strong>SEXO:</strong> {{ $test->client->gender }}</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td style="text-align: right;"><strong>EDAD:</strong> {{ $test->client->age }}</td>
                </tr>
            </table>
            ...
            <table class="data" style="margin-top: 30px; border-collapse: collapse; width: 100%">
                ...
                <tr>
                    ...
                    <td style="color: red; font-weight: bold; text-align: center; text-transform: uppercase;">{{ $test->test_result }}</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
