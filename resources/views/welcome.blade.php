    ...
    <body class="p-4 max-w-7xl mx-auto sm:px-6 lg:px-8 bg-gray-200">
        ...
        <div class="grid md:grid-cols-6 gap-4">
            <form action="{{ route('users.pdf') }}" method="POST">
                ...
                <input class="form-input w-full rounded-md shadow-sm" type="text" name="dni">
                ...
                <input class="form-input w-full rounded-md shadow-sm" type="text" name="lastname">
                ...
                <input class="form-input w-full rounded-md shadow-sm" type="date" name="age">
